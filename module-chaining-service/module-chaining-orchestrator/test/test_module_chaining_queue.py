...
class MyTestCase(unittest.TestCase):
    def test_module_chaining_queue(self):
        ...
        module_chaining_queue.submit_job_to_read_queue(data)
        return_data = module_chaining_queue.fetch_job_to_ready_queue()
    ...
    def test_assert_raised_when_queue_underflow(self):
        ...
        module_chaining_queue.submit_job_to_read_queue(data)
        with self.assertRaises(RuntimeError):
            print(module_chaining_queue.fetch_job_to_ready_queue())
            print(module_chaining_queue.fetch_job_to_ready_queue())
